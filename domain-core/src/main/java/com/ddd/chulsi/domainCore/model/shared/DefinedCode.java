...
public enum DefinedCode implements EnumType {
    ...
    C000500002("C0005", "정책 카테고리", "00002", "온보딩 기본 이미지 1배수"),
    C000500003("C0005", "정책 카테고리", "00003", "온보딩 기본 이미지 2배수"),
    C000500004("C0005", "정책 카테고리", "00004", "온보딩 기본 이미지 3배수"),
    C000500005("C0005", "정책 카테고리", "00005", "메인 목록 기본 이미지 1배수"),
    C000500006("C0005", "정책 카테고리", "00006", "메인 목록 기본 이미지 2배수"),
    C000500007("C0005", "정책 카테고리", "00007", "메인 목록 기본 이미지 3배수"),
    C000500008("C0005", "정책 카테고리", "00008", "메인 리스트뷰 기본 이미지 1배수"),
    C000500009("C0005", "정책 카테고리", "00009", "메인 리스트뷰 기본 이미지 2배수"),
    C000500010("C0005", "정책 카테고리", "00010", "메인 리스트뷰 기본 이미지 3배수"),
    C0006("C0006", "도메인 종류", "", ""),
