package com.sikdorok.appapi.infrastructure.exception.message;
...
public class ErrorMessage {
    ...
    public static final String FILE_GET_FAILED = "파일 불러오기에 실패했습니다.";
    ...
    public static final String JSON_DE_SERIALIZED_FAILED = "Json 처리에 실패했습니다.";
