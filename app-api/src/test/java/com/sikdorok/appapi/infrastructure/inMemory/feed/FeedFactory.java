package com.sikdorok.appapi.infrastructure.inMemory.feed;
...
import com.sikdorok.appapi.infrastructure.inMemory.photos.PhotosFactory;
...
public class FeedFactory {
    ...
    public static FeedInfo.FeedInfoDTO givenFeedInfo() {
        return FeedInfo.FeedInfoDTO.toDTO(
            givenFeed(),
            true,
            PhotosFactory.givenPhotosInfoList(),
            0
        );
    }
